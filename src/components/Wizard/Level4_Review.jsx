...
const Level4_Review = ({ data, back }) => {
  ...
  return (
    <div className="animate-fade-in text-white relative">
      ...
      {/* DOCUMENT PREVIEW */}
      <div className="bg-white text-slate-900 p-8 rounded-lg shadow-2xl max-w-4xl mx-auto mb-8 relative overflow-hidden print:shadow-none print:w-full print:max-w-none">
        ...
        <div className="mb-10 bg-slate-50 p-6 rounded-xl border border-slate-200">
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-4 justify-between">
            ...
            {/* NODE 1: PROBLEM */}
            <div className="flex-1 bg-red-50 border border-red-200 rounded p-4 relative">
              <span className="absolute -top-3 left-4 bg-red-100 text-red-700 text-[10px] px-2 py-0.5 rounded font-bold tracking-wider">PROBLEM</span>
            ...
            {/* NODE 2: INTERVENTION (Stacked) */}
            <div className="flex-1 bg-blue-50 border border-blue-200 rounded p-4 relative flex flex-col justify-center gap-2">
              <span className="absolute -top-3 left-4 bg-blue-100 text-blue-700 text-[10px] px-2 py-0.5 rounded font-bold tracking-wider">ACTIVITIES</span>
            ...
            {/* NODE 3: GOAL */}
            <div className="flex-1 bg-green-50 border border-green-200 rounded p-4 relative">
              <span className="absolute -top-3 left-4 bg-green-100 text-green-700 text-[10px] px-2 py-0.5 rounded font-bold tracking-wider">GOAL</span>

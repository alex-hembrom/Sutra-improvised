...
const TEMPLATES = {
  ...
  fln: {
    ...
    data: {
      problem:
        "Grade 3 students in rural districts lack basic reading fluency.",
          ...
          <div className="flex items-center">
            {[1, 2, 3, 4, 5, 6].map((step, index) => (
              <div key={step} className="flex items-center">
                {index > 0 && (
                  <div
                    className={`h-[2px] w-8 md:w-12 transition-all duration-700 ${
                      step <= level
            ...
            {level === 0 && (
              <div className="text-center pt-10">
                ...
                <p className="text-slate-400 font-mono mb-12">
                  CHOOSE A TEMPLATE TO INITIALIZE PROTOCOLS
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {Object.entries(TEMPLATES).map(([key, template]) => (
                    ...
                    >
                      <h3 className="text-xl font-bold text-white mb-2 group-hover:text-cyan-400 font-display">
                        {template.title}
                      </h3>

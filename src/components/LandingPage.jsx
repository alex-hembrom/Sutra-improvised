...
const LandingPage = () => {
  ...
  return (
    // Main container
    <div className="w-full flex flex-col relative font-sans text-white selection:bg-cyan-500/30 overflow-x-hidden px-4 sm:px-6 md:px-8 lg:px-12 scrollbar-hide">
      ...
      {/* Content wrapper with conditional animation */}
      <div className={`w-full flex flex-col flex-1 relative z-10 ${!animationFinished ? 'animate-crt-turn-on' : 'opacity-100'}`}>
        
        {/* Optimized background glows */}
        <div className="absolute top-0 left-0 z-0 pointer-events-none overflow-hidden">
          <div className="w-[30vw] sm:w-[25vw] md:w-[20vw] max-w-[420px] h-[30vw] sm:h-[25vw] md:h-[20vw] max-h-[420px] bg-purple-600/25 blur-[60px] sm:blur-[80px] md:blur-[100px] rounded-full -translate-x-1/2 -translate-y-1/2 mix-blend-screen animate-pulse-slow transform-gpu will-change-transform"></div>
        </div>
        <div className="absolute bottom-0 right-0 z-0 pointer-events-none overflow-hidden">
          <div
            className="w-[30vw] sm:w-[25vw] md:w-[20vw] max-w-[420px] h-[30vw] sm:h-[25vw] md:h-[20vw] max-h-[420px] bg-blue-600/25 blur-[60px] sm:blur-[80px] md:blur-[100px] rounded-full translate-x-1/2 translate-y-1/2 mix-blend-screen animate-pulse-slow transform-gpu will-change-transform"
            style={{ animationDelay: "1s" }}
          ></div>
        </div>

        {/* Background grid */}
        <div className="absolute inset-0 z-0 bg-[linear-gradient(rgba(0,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,255,255,0.03)_1px,transparent_1px)] bg-[size:50px_50px] animate-grid-scroll opacity-50 pointer-events-none"></div>
        ...
        <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between relative z-10 px-4 sm:px-6 md:px-8 mt-8 sm:mt-10 md:mt-10 gap-6 md:gap-10">
          ...
          <div className="flex-1 flex justify-center items-center relative mt-8 md:mt-0 w-full">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[22vw] sm:w-[30vw] md:w-[35vw] max-w-[700px] h-[22vw] sm:h-[30vw] md:h-[35vw] max-h-[700px] bg-cyan-500/20 blur-[50px] sm:blur-[80px] md:blur-[100px] rounded-full animate-pulse-slow transform-gpu"></div>

            <div className="animate-float z-10 relative w-full transform-gpu will-change-transform">
              <img
                src={roboReading}
                alt="Sutra Assistant"
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <div className="flex-1 flex justify-center items-center relative order-2 md:order-1 w-full">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[20vw] sm:w-[18vw] md:w-[14vw] max-w-[400px] h-[20vw] sm:h-[18vw] md:h-[14vw] max-h-[400px] bg-red-600/20 blur-[40px] sm:blur-[60px] md:blur-[80px] rounded-full animate-pulse-slow transform-gpu"></div>
              <div
                className="animate-float z-10 relative transform-gpu will-change-transform"
                style={{ animationDelay: "1s" }}
              >
                <img
                  src={roboThinking}
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
            ...
            <div className="flex-1 flex justify-center items-center relative w-full">
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[20vw] sm:w-[18vw] md:w-[14vw] max-w-[400px] h-[20vw] sm:h-[18vw] md:h-[14vw] max-h-[400px] bg-cyan-500/20 blur-[40px] sm:blur-[60px] md:blur-[80px] rounded-full animate-pulse-slow transform-gpu"></div>
              <div
                className="animate-float z-10 relative transform-gpu will-change-transform"
